      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="flex flex-col items-start max-w-[900px] mb-16 lg:mb-24 animate-fade-in-up">
          ...
          <h2 className="text-[38px] sm:text-[46px] md:text-[56px] font-semibold text-[var(--color-primary)] leading-[1.05] tracking-tight mb-8">
            ROOTED IN INDIA.<br />
            <span className="">CONNECTED TO SINGAPORE.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="lg:col-span-7 bg-[#F8FAFC] border border-gray-200 rounded-[24px] p-8 md:p-12 lg:p-16 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            <div className="mb-14">
              <span className="inline-block text-[10px] md:text-[11px] font-bold tracking-[0.25em] uppercase text-[var(--color-accent)] bg-white border border-gray-200 px-4 py-2 rounded-full mb-8 shadow-sm">
                Primary Operation
              </span>
              <h3 className="text-[36px] md:text-[48px] lg:text-[56px] font-semibold text-gray-900 leading-none tracking-tight mb-4">
                INDIA
              </h3>
              <div className="text-[14px] md:text-[16px] font-bold tracking-[0.2em] uppercase text-[var(--color-accent)]">
                Xenex Fiber Works
              </div>
            </div>
            
            <div className="pt-10 border-t border-gray-200">
              <span className="text-[10px] md:text-[11px] font-bold tracking-[0.25em] uppercase text-[var(--color-accent)] block mb-5">
                Core Focus
              </span>
          ...
          <div className="lg:col-span-5 bg-white border border-gray-200 rounded-[24px] p-8 md:p-10 lg:p-12 shadow-[0_8px_40px_rgba(0,0,0,0.02)] animate-fade-in-up flex flex-col justify-between" style={{ animationDelay: '0.2s' }}>
            <div className="mb-12">
              <span className="inline-block text-[10px] md:text-[11px] font-bold tracking-[0.25em] uppercase text-[var(--color-accent)] bg-gray-50 px-4 py-2 rounded-full mb-8">
                International Presence
              </span>
              <h3 className="text-[28px] md:text-[36px] font-semibold text-gray-900 leading-none tracking-tight mb-4">
                SINGAPORE
              </h3>
              <div className="text-[12px] md:text-[13px] font-bold tracking-[0.15em] uppercase text-[var(--color-accent)] leading-relaxed">
                Xenex Engineering &amp; Process Pte Ltd
              </div>
            </div>
            
            <div className="pt-8 border-t border-gray-100">
              <span className="text-[10px] md:text-[11px] font-bold tracking-[0.25em] uppercase text-[var(--color-accent)] block mb-4">
                Core Focus
              </span>
